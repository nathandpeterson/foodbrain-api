  ...
  return knex('foods').del()
    .then(function () {
      ...
      return knex('foods').insert([
        ...
        {id: 4, name: 'canola oil', quantity: 10, unit: 'fluid ounces', perishable: false, category: 8},
        ...
        {id: 9, name: 'cheez-its', quantity: 1, unit: 'box', perishable: false, category: 7},
        ...
        {id: 13, name: 'cinnamon', quantity: 1, unit: 'jar', perishable: false, category: 8}
      ])
    })
}
